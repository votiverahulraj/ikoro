<x-guest-layout>
    @push('styles')
        ...
        <style>
            ...
            /* Mapbox Autofill Suggestions Styling (Airbnb-like) */
...
@endforeach
    ...
    @push('scripts')
        ...
        <!-- Mapbox SearchBox for Place Search (NOT Autofill) -->
        <script>
            const MAPBOX_TOKEN = 'pk.eyJ1IjoiaWtvcm9ocSIsImEiOiJjbWdkc2tkcGYxbWJoMmpxdzV5dm10cjhhIn0.TpAnavdsPjHbTMD1N1OsEw';

            // Initialize Mapbox SearchBox for PLACE search (cities, countries, regions)
            window.addEventListener('load', () => {
                ...
                try {
                    ...
                    // Create SearchBox (for places, NOT addresses)
                    const searchBox = new mapboxsearch.MapboxSearchBox();
                    searchBox.accessToken = MAPBOX_TOKEN;
                    searchBox.options = {
                        language: 'en',
                        types: 'country,region,place,locality',  // NO address or poi
                        limit: 5
                    };

                    // Bind to input
                    searchBox.bindSearchBox(searchInput);

                    console.log('[Search] Mapbox SearchBox initialized (places only)');

                    // Listen for place selection
                    searchBox.addEventListener('retrieve', (e) => {
                        console.log('[Search] Place selected:', e);
                        ...
                        if (feature && feature.geometry && feature.geometry.coordinates) {
                            ...
                            // Format display value in AIRBNB ORDER: Country, State, City, Postcode
